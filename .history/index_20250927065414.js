...
app.post("/path3", async (req, res)=>{
  ...
  let x= new pages({page: "<!DOCTYPE html>
    <head>
        <title>Main Menu</title>
        <style>
            #container{
                background-color: rgb(136, 183, 245);
                width: 30rem;
                height: 26rem;
            }
            #title{
            ...
            #pic{
                width: 6rem;
                height: 6rem;
                background-color: rgb(106, 248, 50);
            }
            .labels{
                font-size: 15px;
                width: 4rem;
        ...
        <body bgcolor="cyan">
            <div id="container">
                <h4 id="title"> Main Menu</h4>
                <div id="pic">Pic</div>
                <h4 class="labels">Name</h4>
                <h4 class="labels">phone</h4>
                <button id="bt1" onclick="f1()">Button 1</button>
            </div>
        </body>
        <script>

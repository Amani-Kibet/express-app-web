...
let labels= new mongoose.Schema({phone: String, password: String})
let users= mongoose.model("Users", labels)

app.post("/path1", (req, res)=>{
  console.log(req.body);
  let user= new users({phone: req.body.phone, password: req.body.pass})
  user.save()

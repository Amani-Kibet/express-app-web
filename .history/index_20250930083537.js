...
app.post("/path1/sign", filex.single("image"), (req, res)=>{
...
app.post("/chat/path1", async (req, res)=>{
  app.post(`/line/${req.body.phone}`, async (req, res)=>{
...
app.post("/path3", async (req, res)=>{
  ...
  app.post("/path5", async (req, res)=>{
    app.psot(`line/${req.body.phone}/msg`, (req, res)=>{
